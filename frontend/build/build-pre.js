...
async function getRemoteUrl() {
    return new Promise((resolve, reject) => {
        exec("git config --get remote.origin.url", (error, stdout, stderr) => {
            ...
            // format is either:
            // git@github.com:https://github.com/CentreForDigitalHumanities/gen-ai-reflection.git
            // or https://github.com/https://github.com/CentreForDigitalHumanities/gen-ai-reflection.git
            // or https://USERNAME:SECRET@github.com/https://github.com/CentreForDigitalHumanities/gen-ai-reflection.git/
...
Promise.all([getHash(), getRemoteUrl()])
    .then(([hash, remoteUrl]) => {
